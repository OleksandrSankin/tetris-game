...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ФигураСтупенька фигураСтупенька = new ФигураСтупенька(field);
        ФигураТ  фигураТ = new ФигураТ(field);
        ...
        while (true) {
            ...
            if (action == Action.Right) {
                ...
                фигураСтупенька.перевернутьВправо();
                фигураТ.перевернутьВправо();
                ...
                фигураСтупенька.перевернутьВлево();
                фигураТ.перевернутьВлево();
                ...
                фигураСтупенька.двигатьсяВниз();
                фигураТ.перевернуть180();
