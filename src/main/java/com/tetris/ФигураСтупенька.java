...
public class ФигураСтупенька {
    ...
    public void перевернутьВлево() {
        if (фигураНеПеревернута) {
            ...
            новаяКоордината[3] = new Координата(this.координата[3].getX() +1, this.координата[3].getY() + 2);
