...
public class ФигураТ {
    ...
    public void перевернутьВлево() {
        if (фигураНеПеревернута) {
            ...
            новаяКоордината[0] = new Координата(this.координата[0].getX(), this.координата[0].getY());
